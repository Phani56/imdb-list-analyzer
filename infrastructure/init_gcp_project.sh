...
# Credits to Scott Winkler, original script from:
# https://www.github.com/scottwinkler/manning-code/blob/master/chapter7/complete/bootstrap.sh
...
gcloud services enable cloudresourcemanager.googleapis.com serviceusage.googleapis.com compute.googleapis.com sourcerepo.googleapis.com cloudbuild.googleapis.com containerregistry.googleapis.com
